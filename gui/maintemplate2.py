...
class Ui_MainWindow(object):
    ...
    def displaycurrentstate(self,rootNode):
        ...
        self.p6_pBet.setHidden(rootNode.pbetCurrentRound[5]==0)
        self.p1_pBet.setHidden(rootNode.pbetCurrentRound[0]==0)
        self.p2_pBet.setHidden(rootNode.pbetCurrentRound[1]==0)
        self.p3_pBet.setHidden(rootNode.pbetCurrentRound[2]==0)
        self.p4_pBet.setHidden(rootNode.pbetCurrentRound[3]==0)
        self.p5_pBet.setHidden(rootNode.pbetCurrentRound[4]==0)

        self.p6_pBet.setText(str(rootNode.pbetCurrentRound[5]))
        self.p1_pBet.setText(str(rootNode.pbetCurrentRound[0]))
        self.p2_pBet.setText(str(rootNode.pbetCurrentRound[1]))
        self.p3_pBet.setText(str(rootNode.pbetCurrentRound[2]))
        self.p4_pBet.setText(str(rootNode.pbetCurrentRound[3]))
        self.p5_pBet.setText(str(rootNode.pbetCurrentRound[4]))
        ...
        if len(rootNode.chips)>0:  
            self.pot1.setHidden(False)
            self.pot1.setText("Pot1: "+str(int(rootNode.chips[0])))
        if len(rootNode.chips)>1:    
            self.pot2.setHidden(False)
            self.pot2.setText("Pot2: "+str(int(rootNode.chips[1])))
        if len(rootNode.chips)>2: 
            self.pot3.setHidden(False)
            self.pot3.setText("Pot3: "+str(int(rootNode.chips[2])))
        if len(rootNode.chips)>3: 
            self.pot4.setHidden(False)
            self.pot4.setText("Pot4: "+str(int(rootNode.chips[3])))
        if len(rootNode.chips)>4: 
            self.pot5.setHidden(False)
            self.pot5.setText("Pot5: "+str(int(rootNode.chips[4])))

        self.allin_p1.setHidden(not rootNode.pAllin[0])
        self.allin_p2.setHidden(not rootNode.pAllin[1])
        self.allin_p4.setHidden(not rootNode.pAllin[3])
        self.allin_p3.setHidden(not rootNode.pAllin[2])
        self.allin_p5.setHidden(not rootNode.pAllin[4])
        self.allin_p6.setHidden(not rootNode.pAllin[5])

        if rootNode.bettingRound==0:
            self.cards_b1.setHidden(True)
            self.cards_b2.setHidden(True)
            self.cards_b3.setHidden(True)
            self.cards_b4.setHidden(True)
            self.cards_b5.setHidden(True)
        elif rootNode.bettingRound==1:
            self.cards_b1.setPixmap(QtGui.QPixmap("../resources/deck/"+rootNode.board[0]+".png"))
            self.cards_b2.setPixmap(QtGui.QPixmap("../resources/deck/"+rootNode.board[1]+".png"))
            self.cards_b3.setPixmap(QtGui.QPixmap("../resources/deck/"+rootNode.board[2]+".png"))
            self.cards_b1.setHidden(False)
            self.cards_b2.setHidden(False)
            self.cards_b3.setHidden(False)
            self.cards_b4.setHidden(True)
            self.cards_b5.setHidden(True)
        elif rootNode.bettingRound==2:
            self.cards_b1.setPixmap(QtGui.QPixmap("../resources/deck/"+rootNode.board[0]+".png"))
            self.cards_b2.setPixmap(QtGui.QPixmap("../resources/deck/"+rootNode.board[1]+".png"))
            self.cards_b3.setPixmap(QtGui.QPixmap("../resources/deck/"+rootNode.board[2]+".png"))
            self.cards_b4.setPixmap(QtGui.QPixmap("../resources/deck/"+rootNode.board[3]+".png"))
            self.cards_b1.setHidden(False)
            self.cards_b2.setHidden(False)
            self.cards_b3.setHidden(False)
            self.cards_b4.setHidden(False)
            self.cards_b5.setHidden(True)
        elif rootNode.bettingRound==3:
            self.cards_b1.setPixmap(QtGui.QPixmap("../resources/deck/"+rootNode.board[0]+".png"))
            self.cards_b2.setPixmap(QtGui.QPixmap("../resources/deck/"+rootNode.board[1]+".png"))
            self.cards_b3.setPixmap(QtGui.QPixmap("../resources/deck/"+rootNode.board[2]+".png"))
            self.cards_b4.setPixmap(QtGui.QPixmap("../resources/deck/"+rootNode.board[3]+".png"))
            self.cards_b5.setPixmap(QtGui.QPixmap("../resources/deck/"+rootNode.board[4]+".png"))
            self.cards_b1.setHidden(False)
            self.cards_b2.setHidden(False)
            self.cards_b3.setHidden(False)
            self.cards_b4.setHidden(False)
